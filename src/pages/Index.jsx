...
const Index = () => {
  ...
  const handleManualVerification = () => {
    setManualVerification(!manualVerification);
  };
            ...
            <TabsContent value="settings">
              <div className="w-full">
                ...
                <div className="flex items-center space-x-2">
                  <label htmlFor="swap-roi">Swap ROI Direction</label>
                  <Switch id="swap-roi" checked={swapRoi} onCheckedChange={handleSwapRoi} />
                </div>
                <div className="flex items-center space-x-2">
                  <label htmlFor="manual-verification">Manual Verification</label>
                  <Switch id="manual-verification" checked={manualVerification} onCheckedChange={handleManualVerification} />
                </div>
              </div>
            </TabsContent>
          </Tabs>
